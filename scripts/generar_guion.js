...
const instruccionPromocion =
  promo && promo.activa
    ? `\nEl cuerpo del video debe dar datos o información realmente interesante y útil sobre el tema (esto es lo más importante, el valor real del video). AL FINAL, en TODOS los videos sin excepción, agrega 1 frase corta invitando a ver el canal de ofertas en Telegram. IMPORTANTE: NUNCA menciones el nombre exacto del canal ("Benatechs Descuentos") ni ninguna URL en el audio hablado — Whisper los transcribe mal y suenan raro. En cambio di algo simple y variado como: "el link lo dejo en los comentarios", "encuéntralo en los comentarios", "te dejo el enlace abajo" — algo que suene natural sin nombrar el canal específico. La URL sí va en la descripción escrita del video, no en el guion hablado.`
    : "";
